...
var spread_angle2 := 17.0
var bullets_per_burst2 := 2
...
func _on_cooldown_timeout() -> void:
	...
	if player and star_chance <= 69:
		...
		bullet.speed = bullet_speed - 650.0
...
func _on_burst_cooldown_timeout() -> void:
	...
	if player:
		...
		for i in range(bullets_per_burst):
			...
			bullet.velocity = direction * burst_speed
		...
		for i in range(bullets_per_burst2):
			...
			bullet2.velocity = dir2 * burst_speed
